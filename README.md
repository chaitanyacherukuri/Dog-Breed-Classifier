...
In this project, I perform the knowledge transfer technique over the existing neural network: [Resnet50](https://keras.io/applications/#resnet50) to classify dog breeds from images.

For comparison, I first create my own CNN from scratch, obtaining a sad accuracy of 5%.

With my neural network on top of Resnet50, my accuracy score goes up to 83%.
